    ...
    return (
        <div className='flex flex-col w-full'>
            ...
            <div className='flex flex-row w-full mt-5'>
                <div className='flex flex-col w-2/3 shadow-md rounded-lg p-2 mr-1'>
                    <div className='flex flex-row w-full'>
                        ...
                        <StatComponent color='yellow' contentone={'Streak'} contenttwo={3} contentthree={'Longest Streak 14'} />
                    </div>
                    <StatButtons />
