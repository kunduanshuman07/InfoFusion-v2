    ...
    return (
        <div className="drawer">
            ...
            <div className="drawer-content">
                <label htmlFor="my-drawer" className="btn btn text-[#0ea5e9] bg-white border-none hover:bg-[#e0f2fe] drawer-button">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-50 min-h-full bg-base-200 text-base-content">
                    ...
                    <li className=" text-md mt-3"><a><MdDashboard className="mr-3"/> Dashboard</a></li>
                    ...
                    <li className=" text-md mt-auto"><a><MdSupportAgent className="mr-3"/> Support</a></li>
