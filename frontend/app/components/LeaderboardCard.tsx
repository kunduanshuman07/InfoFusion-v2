...
const LeaderboardCard:React.FC<LeaderboardCardProps> = ({rank, username, rating, highest_score, attempts, correct_answers}) => {
  return (
    <div className="flex flex-row w-full mt-4 shadow-md rounded-lg p-2">
        <div className={`w-1/12 flex flex-row ${rank===1?'text-[#f59e0b] font-bold': rank===2? 'text-[#92400e] font-bold':rank===3?'text-[#64748b] font-bold': ''}`}>
