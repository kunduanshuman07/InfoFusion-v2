...
const QuizSelection = () => {
  ...
  return (
    <div className="p-2 shadow-md rounded-lg flex flex-col">
      ...
      <button className="btn bg-[#0c4a6e] m-auto mt-2 mb-1 text-white hover:btn-neutral mt-4" onClick={handleQuizPopUp}>Start Quiz</button>
      <button className="btn text-xs m-auto btn-xs text-[#0ea5e9] bg-[#e0f2fe] pl-10 pr-10 hover:bg-[#e0f2fe] mt-4">Attempt past Quizzes</button>
