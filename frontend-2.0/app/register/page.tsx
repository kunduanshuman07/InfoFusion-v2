...
const Register = () => {
  ...
  return (
    <div className={`flex flex-col p-4 shadow-md border rounded-lg mx-auto my-10 sm:w-1/3 w-full`}>
      ...
      <button className="btn btn-sm mt-4 bg-cyan-600 hover:bg-cyan-500 text-white" onClick={handleRegister} disabled={loading}>Sign Up</button>
